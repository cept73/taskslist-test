...
<head>
    ...
    <title><?php echo e($site_name ?? 'Site name'); ?> &ndash; <?php echo $__env->yieldContent('title'); ?></title>

    <!-- Base -->
    <base href="<?php echo e($site_url ?? '/'); ?>" />
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">
          <?php echo e($site_name ?? 'Site name'); ?>

           <sup><small>v<?php echo e($version ?? '1.0'); ?></small></sup>
        </div>
      </a>
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item no-arrow">
              <?php if(isset($user) and $user['logged']): ?>
                <div class="nav-link" id="userDropdown" role="button">
                  <span class="mr-2 d-none d-lg-inline text-gray-600"><?php echo e($user['login']); ?></span>
                  <img class="img-profile rounded-circle" src="<?php echo e($user['avatar'] ?? '/public/assets/img/avatar.jpg'); ?>">
                </div>
              <?php else: ?>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; 2019 <?php echo e($copyright ?? 'Task Manager by Cept'); ?></span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
