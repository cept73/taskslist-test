            ...
            <form class="user" method="post">
                <div class="form-group">
                    <input type="login" class="form-control form-control-user" name="login" id="InputLogin" aria-describedby="loginHelp" placeholder="Enter Login..."
                        value="<?php if(isset($login)): ?> <?php echo e($login); ?> <?php endif; ?>">
                </div>
                <div class="form-group">
...
<?php echo $__env->make('layouts.app-clean', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/views/login.blade.php ENDPATH**/ ?>